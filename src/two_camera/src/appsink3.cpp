...
int main(int argc, char *argv[])
{
    ...
    auto node = rclcpp::Node::make_shared("camera3_10005_publisher");
    auto publisher = node->create_publisher<sensor_msgs::msg::Image>("camera3_10005_image", 10);
    if (!publisher) {
...
static GstFlowReturn new_sample_cb(GstElement *sink, gpointer data)
{
    ...
    if (gst_buffer_map(buffer, &map, GST_MAP_READ)) {
        ...
        msg->header.frame_id = "camera3_10005_frame";
